...
`],encapsulation:2})}return n})();function Ue(n){return n.hasAttribute(`mat-raised-button`)?`elevated`:n.hasAttribute(`mat-stroked-button`)?`outlined`:n.hasAttribute(`mat-flat-button`)?`filled`:n.hasAttribute(`mat-button`)?`text`:null}var Ja=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=Dv({type:n});static ɵinj=Hc({imports:[ge,st]})}return n})();export{st as a,Qa as i,Ee as n,yn as o,Ja as r,Be as t};